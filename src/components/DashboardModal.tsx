          ...
          <main key={tab} className="page-enter min-h-0 flex-1 overflow-y-auto overscroll-contain p-4 sm:p-6 lg:block">
            ...
            {data && (
              <>
                ...
                {tab === "Overview" && (
                  <Panel title="Overview" description="Live account, balance, usage, key, and project data from the local LingoFusion API backend.">
                    <MetricGrid
                      items={[
                    ...
                    <div className="mt-5 grid gap-4 lg:grid-cols-3">
                      <InfoCard icon={ShieldCheck} title="Server-owned keys">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="rounded-lg border border-neutral-200 p-4 dark:border-white/10">
                          ...
                          <ul className="mt-3 space-y-2 text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                            <li>{tc("Authenticates the Bearer key server-side.")}</li>
                ...
                {tab === "Billing" && (
                  <Panel title="Billing" description="Add local test balance, see paid versus reward credit, and review the server-side ledger. No real payment provider is connected yet.">
                    <MetricGrid
                      items={[
